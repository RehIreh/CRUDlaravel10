...
<form method="post" action="{{ '/admin/'.$data->nomor_induk }}"
  ...
  <div class="mb-3">
    ...
    <input type="alamat" class="form-control" name='email' id="email" value="{{ $data->email }}">
  </div>
  <div class="mb-3">
    ...
    <select class="form-control" name='jurusan' id="jurusan">
      ...
      <option value="Sistem Informasi Akutansi" {{$data->jurusan == 'Sistem Informasi Akutansi' ? 'selected' : '' }}>Sistem Informasi Akutansi</option>
    </select>
  </div>
  <div class="mb-3">
